...
export const INITIAL_POOLS: SealedPool[] = [
  {
    id: 'pool-blb-01',
    code: '#0094-ARC',
    title: 'Pré-release Sexta-feira Noite',
    setCode: 'BLB',
    ...
    colorCodes: ['G', 'W'],
    synergyArchetype: 'Sinergia Forragear / Filhotes',
    tier: 'Tier A+',
    keyRares: ['Ygra, Devoradora', 'Maha, Plumas da Noite'],
    deckId: 'deck-orzhov-01',
  ...
  },
  {
    id: 'pool-dsk-01',
    code: '#0095-RAS',
    title: 'Torneio Sábado Tarde',
    setCode: 'DSK',
    setName: 'Duskmourn [DSK]',
    status: 'rascunho',
    totalCount: 62,
    score: 74.2,
    recommendedColors: 'Orzhov (Branco / Preto)',
    colorCodes: ['W', 'B'],
    synergyArchetype: 'Salas & Encantamentos Eerie',
    tier: 'Em Progresso',
    keyRares: ['Overlord of the Mistmoors', 'Unholy Annex'],
    createdAt: '2026-09-18T14:30:00Z',
    cards: {
      'dsk-overlord-mistmoors': 1,
      'dsk-sheltered-ghosts': 2,
      'dsk-doomsday-excruciator': 1,
      'dsk-unholy-annex': 1,
      'dsk-nowhere-to-run': 3,
      'dsk-abhorrent-oculus': 1,
      'dsk-cinder-hound': 2,
    }
  },
  {
    ...
    colorCodes: ['U', 'B'],
    synergyArchetype: 'Controle & Vigilantes Noturnos',
    tier: 'Tier B+',
    keyRares: ['Zoraline, Cosmos Caller', 'Maha, Its Feathers Night'],
    deckId: 'deck-orzhov-01',
